...
@Builder
@Data
public class RestaurantBookingDeleteDto {
	private Long rbNo;
	...
	public static RestaurantBooking toEntity(RestaurantBookingDeleteDto dto) {
	...
	public static RestaurantBookingDeleteDto toDto(RestaurantBooking entity) {
		RestaurantBookingDeleteDto dto = RestaurantBookingDeleteDto.builder()
