...
public class RestaurantReviewDeleteDto {
	...
	public static RestaurantReview toEntity(RestaurantReviewDeleteDto dto) {
	...
	public static RestaurantReviewDeleteDto toDto(RestaurantReview entity) {
		RestaurantReviewDeleteDto dto = RestaurantReviewDeleteDto.builder()
													.rrNo(entity.getRrNo())
