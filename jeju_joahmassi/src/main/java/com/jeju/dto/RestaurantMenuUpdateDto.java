...
public class RestaurantMenuUpdateDto {
	...
	public static RestaurantMenu toEntity(RestaurantMenuUpdateDto dto) {
	...
	public static RestaurantMenuUpdateDto toDto(RestaurantMenu entity) {
		RestaurantMenuUpdateDto dto = RestaurantMenuUpdateDto.builder()
