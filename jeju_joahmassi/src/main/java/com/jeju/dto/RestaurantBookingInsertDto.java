...
@Builder
@Data
public class RestaurantBookingInsertDto {
	private Long rbNo;
	...
	public static RestaurantBooking toEntity(RestaurantBookingInsertDto dto) {
	...
	public static RestaurantBookingInsertDto toDto(RestaurantBooking entity) {
		RestaurantBookingInsertDto dto = RestaurantBookingInsertDto.builder()
