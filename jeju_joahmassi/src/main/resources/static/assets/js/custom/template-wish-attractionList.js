export function wish_attractionList_form(responseJsonObject = {}) {
	let htmltemplate = 
	`
		<style>
			/******이미지 사이즈 고정******/
                        ...
                        <div class="u-slick__tab">
                            ...
                            <div class="mb-5">
                                <ul class="nav flex-nowrap border border-radius-3 tab-nav align-items-center py-2 px-0" role="tablist">
                                    ...
                                    -->
                                    <li class="nav-item d-flex align-items-center flex-shrink-0 flex-xl-shrink-1 border-left">
										<a class="nav-link font-weight-normal text-gray-1 text-lh-1dot6 py-1 px-4 px-wd-5 font-weight-normal font-size-15 " href="wishHotel?page=1">숙소
                                        </a>
										<!--
                                        <select class="js-select selectpicker dropdown-select bootstrap-select__custom-nav w-auto" data-style="btn-sm py-1 px-4 px-wd-5 font-weight-normal font-size-15  text-gray-1 d-flex align-items-center">
                                    ...
                                    -->
                                    <li class="nav-item d-flex align-items-center flex-shrink-0 flex-xl-shrink-1 border-left">
                                        <a class="nav-link font-weight-normal text-lh-1dot6 py-1 px-4 px-wd-5 font-weight-normal font-size-15" href="wishAttraction?page=1">명소
                                        </a>
                                    </li>
                                    <li class="nav-item d-flex align-items-center flex-shrink-0 flex-xl-shrink-1 border-left">
                                            ...
                                            <div class="card mb-1 transition-3d-hover shadow-hover-2 tab-card h-100">
                                                <div class="position-relative mb-2">
                                                    <a href="attractionDetail?attractionNo={{attractionNo}}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                                        <img class="min-height-230 bg-img-hero card-img-top" src="assets/img/attractionImage/{{attractionImageDto.[0].imageName}}" alt="img">
                                                    </a>
                                                    <!--
                                                ...
                                                <div class="card-body px-4 py-2">
                                                    ...
                                                    <a href="attractionDetail?attractionNo={{attractionNo}}" class="card-title font-size-17 font-weight-bold mb-0 text-dark">{{attractionName}}</a>
                                                    <div class="my-2">
                            ...
                            <div class="text-center text-md-left font-size-14 mb-3 text-lh-1">Showing {{minus (multiple currentPage pageSize) (minus pageSize 1)}}–{{multiple pageSize currentPage}}</div>
                                <nav aria-label="Page navigation">
                                    <ul class="list-pagination-1 pagination border border-color-4 rounded-sm overflow-auto overflow-xl-visible justify-content-md-center align-items-center py-2 mb-0">
                                        ...
                                        <li class="page-item">
                                            <a class="page-link border-right rounded-0 text-gray-5" href="#/wishAttractionList/previous" aria-label="Previous">
                                        ...
                                        <div id="CategoryOrderInt" class="" hidden="true"></div>
                                        	{{#incrementAndRepeat 0 page}}
                                        		<li class="page-item"><a class="page-link font-size-14" href="#/wishAttractionList/page/{{plus this 1}}" page={{plus this 1}}>{{plus this 1}}</a></li>
                                        	{{/incrementAndRepeat}}
                                        {{/with}}
                                        <!--
                                        ...
                                        {{#ifCond nextSize '>' 0}}
                                        <li class="page-item">
                                            <a class="page-link border-left rounded-0 text-gray-5" href="#/wishAttractionList/next" aria-label="Next">
